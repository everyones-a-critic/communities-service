...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn = "arn:aws:execute-api:${var.region}:${var.aws_account_id}:${data.tfe_outputs.api_gateway.values.gateway_id}/*/${aws_api_gateway_method.method.http_method}${aws_api_gateway_resource.communities.path}"
}